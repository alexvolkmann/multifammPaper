...
We fit two multiFAMM-models: `m_mul` corresponds to the model presented in the main part and `m_wei` corresponds to the model of the sensitivity analysis in the appendix using a weighted scalar product. Additionally, we fit two univariate FAMM-models: `m_aco` and `m_epg`.
